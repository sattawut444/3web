...
const MyComponent = () => {
  ...
  return (
    ...
    <div style={{ zIndex: 5, display: 'flex', backgroundColor: 'black', position: 'fixed', top:0, width: '100%', boxShadow: '0px 2px 9px rgba(0, 0, 0, 5)'}}>
      <div style={{ flex: 1 }}>
      <img className="logobar"src="/image/LOGO-2 1.png" height="auto" />
      ...
      <div style={{ flex: 1, paddingRight: '5%', display: 'flex', justifyContent: 'right', alignItems: 'center', backgroundColor: 'black'}}>
        <svg className="imagebar" style={{ marginRight: '1%' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        ...
        <svg className="imagebar" style={{ marginRight: '1%' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <svg className="imagebar" style={{ marginRight: '1%' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
